...
public class Ex03_LinkedList {
	public static void main(String[] args) {
		...
		for(int i = 0; i<10000;i++) {
			listArray.add(0,i+"");//0번 인덱스에 끼워 넣기 처리를함.  Linked가 끼워넣기는 더 빠르다
		}
		...
		startTime = System.nanoTime();
		for(int i = 0; i<10000;i++) {
			listLinkded.add(0,i+"");//0번 인덱스에 끼워 넣기 처리를함.  Linked가 끼워넣기는 더 빠르다
		}
		endTime = System.nanoTime();
		System.out.println("LikedList의 작업 시간 : "+(endTime - startTime)+"ns");
	}
	}
