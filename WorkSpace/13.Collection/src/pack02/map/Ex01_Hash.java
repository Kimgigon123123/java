...
// 		데이터를 식별할 수 있는 해시코드를 기준으로 데이터를 저장하는 것 (Hash Set)
		...
		//HashSet 자료구조는 index로 접근하는게 아니라 요소별로 접근을 하는것을 권장함.
		//여기부분은 iterator 라는게 어떤식으로 데이터를 빼오는지만 코드로 보고 외우거나 할 필요 XXX
		Iterator<String> iterator = set.iterator(); //set자료구조를  탐색 할 수 있는 기능을 가짐 (반복자)
